...
public class Level_2 extends Level implements Serializable {
    public Level_2() {
        levelName = "LEVEL TWO";
        background = Textures.TextureName.BRICKS_BLUE;
        ...
        walls[0] = new WallEntity(new Polygon(
                ...
                10), Textures.TextureName.BRICKS_RED);
        ...
        character = new CharacterEntity(new Rectangle(10, 350, 40, 40), Textures.TextureName.TARTAN_FABRIC_RED_GREEN);
        finnish = new FinnishEntity(new Rectangle(1225, 130, 40, 40), Textures.TextureName.LEOPARD_SKIN_GRAY);
    }
}
